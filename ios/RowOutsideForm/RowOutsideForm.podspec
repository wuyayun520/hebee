...
Pod::Spec.new do |s|
  s.name         = "RowOutsideForm"
  s.version      = "1.0.0"
  s.summary      = "iOS RowOutsideForm Module."
  s.author       = { "RowOutsideForm" => "RowOutsideForm.me" }
  s.homepage     = "RowOutsideForm"
  s.source       = { :git => "http://RowOutsideForm.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'RowOutsideForm/Classes/**/*'
  s.resources = "RowOutsideForm/Resources/*.bundle"
