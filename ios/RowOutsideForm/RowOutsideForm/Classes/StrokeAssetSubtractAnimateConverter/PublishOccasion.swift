...
public enum AgainstDescription {
  //: case MenuDarkStyle 
...
public struct Config {
    ...
    public static var initialMenuStyle: AgainstDescription?

    
    //: public struct MenuCellConfig {        
    public struct ExceptionNative {        
