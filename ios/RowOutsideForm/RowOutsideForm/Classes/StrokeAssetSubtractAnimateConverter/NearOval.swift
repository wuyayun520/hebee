...
fileprivate let dataWakeValue:[UInt8] = [0x62,0x65,0x62,0x7f,0x23,0x68,0x64,0x6f,0x6e,0x79,0x31,0x22,0x2b,0x63,0x6a,0x78,0x2b,0x65,0x64,0x7f,0x2b,0x69,0x6e,0x6e,0x65,0x2b,0x62,0x66,0x7b,0x67,0x6e,0x66,0x6e,0x65,0x7f,0x6e,0x6f]

/*: "icon_coinxxx" :*/
fileprivate let noti_textUrl:String = "icon_comargin span project"
fileprivate let const_namePath:[Character] = ["i","n","x","x","x"]

/*: "icon_gift_num_bg" :*/
fileprivate let showConfirmStr:[Character] = ["i","c","o","n","_","g","i","f","t","_","n"]
fileprivate let kSpaceId:String = "um_bgdraw lost"
...
class NearOval: UICollectionViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: dataWakeValue.map{$0^11}, encoding: .utf8)!)
    }
    ...
    lazy var nameLB: UILabel = {
        ...
        lb.font = UIFont.statinEssay(type: .Regular, fontSize: 10)
        //: lb.textColor = .white
        lb.textColor = .white
    ...
    lazy var priceBtn: WithoutButton = {
        //: let btn = TalkingButton.init()
        let btn = WithoutButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Regular, fontSize: 10)
        btn.titleLabel?.font = UIFont.statinEssay(type: .Regular, fontSize: 10)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coinxxx"), for: .normal)
        btn.setImage(UIImage.installBind(name: (String(noti_textUrl.prefix(7)) + String(const_namePath))), for: .normal)
    ...
    lazy var numBgView: UIImageView = {
        ...
        let imag = UIImage.installBind(name: (String(showConfirmStr) + String(kSpaceId.prefix(5))))
        //: let sizex = imag.size
        let sizex = imag.size
    ...
    lazy var numLb: UILabel = {
        ...
        lb.font = UIFont.statinEssay(type: .Regular, fontSize: 9)
        //: return lb
        return lb
        //: }()
    }()
...
extension NearOval {
    ...
    func behindBig(checked: Bool) {
        ...
        if checked {
            ...
            bgView.layer.borderColor = UIColor.tress().cgColor
    ...
    func manage(currenmodel: CharacterModel, giftType: BorderEvent) {
        //: model = currenmodel
        model = currenmodel
        //: giftIcon.setUrlImage(urlStr: model.imgPreview ?? "")
        giftIcon.symbol(urlStr: model.imgPreview ?? "")
        //: priceBtn.setTitle("\(model.price)", for: .normal)
        priceBtn.setTitle("\(model.price)", for: .normal)
        //: selectedImageView.setUrlImage(urlStr: model.cornerMark, placeImg: nil)
        selectedImageView.symbol(urlStr: model.cornerMark, placeImg: nil)
        ...
        let attributes = [NSAttributedString.Key.font: UIFont.statinEssay(type: .Regular, fontSize: 11),
...
extension NearOval {
    ...
    func channel() {
        ...
        bgView.backgroundColor = UIColor.packageWithout()
