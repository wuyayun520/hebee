...
fileprivate let dataBetterUrl:[UInt8] = [0x86,0x81,0x86,0x9b,0xc7,0x8c,0x80,0x8b,0x8a,0x9d,0xd5,0xc6,0xcf,0x87,0x8e,0x9c,0xcf,0x81,0x80,0x9b,0xcf,0x8d,0x8a,0x8a,0x81,0xcf,0x86,0x82,0x9f,0x83,0x8a,0x82,0x8a,0x81,0x9b,0x8a,0x8b]

private func helloBack(drop num: UInt8) -> UInt8 {
    return num ^ 239
}
...
class ComposeCheck: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.everyBehavior()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.overCountBehavior()
    ...
    var dropMenuStyle: AgainstDescription? {
        //: didSet {
        didSet {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: dataBetterUrl.map{helloBack(drop: $0)}, encoding: .utf8)!)
    }
    ...
    private func everyBehavior() -> UIImageView {
    ...
    private func overCountBehavior() -> UILabel {
    ...
    private func slide() {
        ...
        lineLayer.strokeColor = UIColor.noticeSatisfy(230, 230, 230, 1.0).cgColor
