...
@objc public enum MasterMaximum: UInt {
...
@objc public enum RenderLibrary: UInt {
 ...
 */
//: @objcMembers public class TaskAction: TCommonCellData {
@objcMembers public class TaskAction: MarkerRole {
    ...
    public var direction: RenderLibrary = .MsgDirectionIncoming
    ...
    public var translateStatus: MasterMaximum = .MsgTranslate_init
    ...
    public var msgModel: ConnectMemberModel = ConnectMemberModel()
    ...
    public var cellLayout: RetainBar!
    ...
    public init(direction: RenderLibrary) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.lemma()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = RetainBar(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = RetainBar(isIncomming: false)
    ...
    public override func city(_ width: CGFloat) -> CGFloat {
