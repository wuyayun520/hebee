...
fileprivate let dataBlocPath:[UInt8] = [0x5a,0x5d,0x5a,0x47,0x1b,0x50,0x5c,0x57,0x56,0x41,0x9,0x1a,0x13,0x5b,0x52,0x40,0x13,0x5d,0x5c,0x47,0x13,0x51,0x56,0x56,0x5d,0x13,0x5a,0x5e,0x43,0x5f,0x56,0x5e,0x56,0x5d,0x47,0x56,0x57]

private func injuryGenerateer(sun num: UInt8) -> UInt8 {
    return num ^ 51
}
...
class WorkEntity: SuccessSSimilar {
    //: var giftData: QuantityegrityMax?
    var giftData: QuantityegrityMax?
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: dataBlocPath.map{injuryGenerateer(sun: $0)}, encoding: .utf8)!)
    }
...
extension WorkEntity {
    ...
    override func associated(with data: MarkerRole) {
        ...
        //: self.giftData = data as? QuantityegrityMax
        self.giftData = data as? QuantityegrityMax
