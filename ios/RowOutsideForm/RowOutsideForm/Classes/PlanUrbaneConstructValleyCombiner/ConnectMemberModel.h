...
/*!消息体数据*/
//: @class AbTalkingChatMsgInfoModel, AbTalkingChatMsgUserModel, AbTalkingChatMsgToUserModel, AbTalkingChatMsgGiftModel, AbTalkingChatMsgTipsModel, TypicalCommand, AbTalkingChatMsgIntimatePhotoModel, AbTalkingChatMsgVideoModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, WantGiftModel;
@class DepthArchitectureModel, EfficiencyModel, SharedResumeThinModel, OvalModel, TriggerModel, TypicalCommand, VerticalBuildReceiveGreenObserverModel, ProvideModel, LibraryModel, SourceShadowExceptionModel, EquipmentModel, FrequencyModel;

//: @interface AbTalkingChatMsgBaseModel : JSONModel
@interface ConnectMemberModel : JSONModel

//: @property (nonatomic, strong)AbTalkingChatMsgInfoModel *msgInfo;
@property (nonatomic, strong)DepthArchitectureModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)EfficiencyModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)SharedResumeThinModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)OvalModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)TriggerModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)SourceShadowExceptionModel *quoteMsgInfo;

//: @property (nonatomic, strong)TypicalCommand *userInfoModel;
@property (nonatomic, strong)TypicalCommand *userInfoModel;
...
@interface DepthArchitectureModel : JSONModel
...
@property (nonatomic, strong) VerticalBuildReceiveGreenObserverModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ProvideModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) LibraryModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) FrequencyModel *wantGift; /// 想要礼物
...
@property (nonatomic, strong) NSArray<ThinModel> *replay; /// v1.9.8 男性用户需要回复的选择内容
...
@interface VerticalBuildReceiveGreenObserverModel : JSONModel
...
+ (void)execute:(VerticalBuildReceiveGreenObserverModel *)photoModel resourceFromRevealRound:(NSString *)msgID;

//: + (NSMutableDictionary<NSString *, NSString *> *)loadLocalIntimatePhotoDict;
+ (NSMutableDictionary<NSString *, NSString *> *)detail;
...
@interface ProvideModel: JSONModel
...
+ (void)generate:(ProvideModel *)videoModel gray:(NSString *)msgID;

//: + (NSMutableDictionary<NSString *, NSString *> *)loadLocalIntimateVideoDict;
+ (NSMutableDictionary<NSString *, NSString *> *)consume;
...
@interface EfficiencyModel : JSONModel
...
@interface SharedResumeThinModel : JSONModel
...
@interface TriggerModel : JSONModel
...
@interface FrequencyModel : JSONModel
...
+ (void)error:(NSString *)msgID;

//: + (NSMutableArray *)loadAskForGiftArr;
+ (NSMutableArray *)beforeObject;

//: @end
@end

//: @interface AbTalkingChatMsgQuoteModel : JSONModel
@interface SourceShadowExceptionModel : JSONModel
...
@property (nonatomic, strong) EquipmentModel *renderData;

//: - (BOOL)isQuoteMsg;
- (BOOL)willEqual;

//: - (CGSize)quoteSize:(NSInteger)maxWidth;
- (CGSize)across:(NSInteger)maxWidth;
