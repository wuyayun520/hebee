...
@objcMembers open class SustainableDepth: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = SustainableDepth()
    //: private(set) var currLanguage: String = FormatDistribution.getSystemLangCode()
    private(set) var currLanguage: String = FormatDistribution.columnistOpen()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func hero(_ language: String) {
...
extension String {
    ...
    public func noneRage(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = LimitIndicator.default.languagePath
