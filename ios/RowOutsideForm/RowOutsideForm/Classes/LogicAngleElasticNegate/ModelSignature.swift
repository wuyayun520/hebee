...
fileprivate let k_structureAbsMsg:[UInt8] = [0xdb,0xdc,0xdb,0xc6,0x9a,0xd1,0xdd,0xd6,0xd7,0xc0,0x88,0x9b,0x92,0xda,0xd3,0xc1,0x92,0xdc,0xdd,0xc6,0x92,0xd0,0xd7,0xd7,0xdc,0x92,0xdb,0xdf,0xc2,0xde,0xd7,0xdf,0xd7,0xdc,0xc6,0xd7,0xd6]
...
class ModelSignature: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_structureAbsMsg.map{$0^178}, encoding: .utf8)!)
    }
