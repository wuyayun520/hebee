...
class DataShared: MasterClip {
    ...
    lazy var topView: ManagerView = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = ManagerView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: SquareFitItem = {
    ...
    lazy var usePhotoView: DrawingWhenView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = DrawingWhenView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension DataShared {
    //: func crushBtnTool(modle: TalkingMomentModel) {
    func tool(modle: ExerciseListen) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==VideoMagnitudeerval.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == VideoMagnitudeerval.share.loginUserMode.sex
        }
