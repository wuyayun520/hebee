...
fileprivate let notiClotData:[UInt8] = [0x5a,0x5d,0x5a,0x47,0x1b,0x50,0x5c,0x57,0x56,0x41,0x9,0x1a,0x13,0x5b,0x52,0x40,0x13,0x5d,0x5c,0x47,0x13,0x51,0x56,0x56,0x5d,0x13,0x5a,0x5e,0x43,0x5f,0x56,0x5e,0x56,0x5d,0x47,0x56,0x57]

private func succeedWait(temporary num: UInt8) -> UInt8 {
    return num ^ 51
}

/*: "btn_me_edit" :*/
fileprivate let k_arrowMarkId:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]
...
class PageActivity: UITableViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: notiClotData.map{succeedWait(temporary: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.installBind(name: (String(k_arrowMarkId))))
...
extension PageActivity {
    ...
    func pic(titile: String, row: Int, isLast: Bool) {
    ...
    func anVersus() {
        ...
        titleBLB.font = UIFont.statinEssay(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.statinEssay(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
    ...
    func poolWithout(detail: String) {
        //: index = 0
        index = 0
        //: islast = true
        islast = true
