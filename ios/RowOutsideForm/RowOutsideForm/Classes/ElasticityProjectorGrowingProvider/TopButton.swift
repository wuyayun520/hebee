...
fileprivate let notiPoseAgileName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_chat_start" :*/
fileprivate let user_invitationPath:[Character] = ["i","c","o"]
fileprivate let mainDetectValue:[Character] = ["n","_","c","h","a","t","_","s","t","a","r","t"]

/*: "icon_chat_lock" :*/
fileprivate let mainLoopTitle:String = "close mention enjoyicon_"

/*: "icon_chat_burned" :*/
fileprivate let mainWhoString:[Character] = ["i","c","o","n","_","c","h","a","t","_","b","u","r","n","e","d"]

/*: "icon_chat_burned_shan" :*/
fileprivate let kConstantStr:String = "icon_cabout very pass warning"
fileprivate let main_secureId:String = "official blank raw way squareurned_s"
fileprivate let const_infrastructureId:String = "manualn"

/*: "Already burned" :*/
fileprivate let noti_socialId:String = "between return announcementAlread"
fileprivate let kQuarterbackMessage:String = "icon"
...
class TopButton: SuccessSSimilar {
    //: var videoData: SharedImplementation?
    var videoData: SharedImplementation?
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: notiPoseAgileName.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var playImgView: UIImageView = {
        ...
        imgV.image = UIImage.installBind(name: (String(user_invitationPath) + String(mainDetectValue)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var lockImgView: UIImageView = {
        ...
        imgV.image = UIImage.installBind(name: (String(mainLoopTitle.suffix(5)) + "chat_lock"))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var burnedImgView: WithoutButton = {
        ...
        imgV.setBackgroundImage(UIImage.installBind(name: (String(mainWhoString))), for: .normal)
        //: imgV.setImage(UIImage.BundleImageNamed(name: "icon_chat_burned_shan"), for: .normal)
        imgV.setImage(UIImage.installBind(name: (String(kConstantStr.prefix(6)) + "hat_b" + String(main_secureId.suffix(7)) + const_infrastructureId.replacingOccurrences(of: "manual", with: "ha"))), for: .normal)
        //: imgV.imageAlignment = .top
        imgV.imageAlignment = .top
        //: imgV.setTitle("Already burned".localized, for: .normal)
        imgV.setTitle((String(noti_socialId.suffix(6)) + "y burne" + kQuarterbackMessage.replacingOccurrences(of: "icon", with: "d")).localized, for: .normal)
...
extension TopButton {
    ...
    override func associated(with data: MarkerRole) {
        ...
        //: self.videoData = data as? SharedImplementation
        self.videoData = data as? SharedImplementation
        ...
        self.dutationLab.text = NSDate.line(totalTime: duration)
        ...
        self.opendFeed(urlStr: videoModel.coverImg, isMosaic: imgIsMosaic)
    }
    ...
    func opendFeed(urlStr: String, isMosaic: Bool) {
        //: guard let newData = self.videoData else { return }
        guard let newData = self.videoData else { return }
        ...
        if !coverImgPath.isEmptyString, isExit { // 加载本地
            ...
            //: if isMosaic {
            if isMosaic {
                //: self.picImgView.image = UIImage.app(image, sort: 90)
                self.picImgView.image = UIImage.app(image, sort: 90)
                //: } else {
            } else {
            ...
            self.picImgView.ratingOperate(urlStr: urlStr) { [weak self] image in
