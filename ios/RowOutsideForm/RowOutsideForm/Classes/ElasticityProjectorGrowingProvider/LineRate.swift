...
struct LineRate: HandyJSON {
    ...
    var momentPic: ExceptionIndicator?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [PropertyTitle]? // 相册
...
struct ExceptionIndicator: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [ZoneArchitecture]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct ZoneArchitecture: HandyJSON {
...
struct PropertyTitle: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func medal(compareTo: PropertyTitle) -> Bool {
        //: return
        return
