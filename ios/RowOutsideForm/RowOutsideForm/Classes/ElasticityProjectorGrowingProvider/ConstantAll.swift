...
extension ConstantAll {
    ...
    func plainPick(_ frontCamera: Bool) {
        ...
        self.belowVoice(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func translateError(_ openCamera: Bool) {
        ...
        self.reductionNameGroup(isOpen: openCamera)
    }
    ...
    func doinglyPost() {
        ...
        DispatchQueue.main.async {
            ...
            self.creationMargin(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension ConstantAll {
    ...
    private func belowVoice(front: Bool) {
    ...
    private func reductionNameGroup(isOpen: Bool) {
        //: if isOpen {
        if isOpen {
...
extension ConstantAll {
    ...
    func builderSensor() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(replyAcross(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(disappearLayer(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(combineTypical(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(aboveVia(notif:)),
    ...
    @objc private func replyAcross(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func disappearLayer(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func combineTypical(notif: Notification) {
    ...
    @objc func aboveVia(notif: Notification) {
...
extension ConstantAll {
    ...
    func noOdd() {
        ...
        if self.infoModel?.videoStage == .Waiting {
            ...
            creationMargin(smallWindow: false)
        ...
        //: } else if self.infoModel?.videoStage == .Calling {
            ...
            //: } else {
                ...
                creationMargin(smallWindow: true)
            }
        }
    ...
    func creationMargin(smallWindow: Bool) {
