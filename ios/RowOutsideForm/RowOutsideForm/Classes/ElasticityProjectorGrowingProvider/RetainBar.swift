...
@objcMembers public class RetainBar: NSObject {
    ...
    class func towardInstall() -> RetainBar {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = RetainBar.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func picFor() -> RetainBar {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = RetainBar.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func outsideSubstantial() -> RetainBar {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = RetainBar.init(isIncomming: false)
        //: return layout
        return layout
