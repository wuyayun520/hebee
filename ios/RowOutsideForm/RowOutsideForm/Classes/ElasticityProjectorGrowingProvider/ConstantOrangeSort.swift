...
fileprivate let data_randomStackNoValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let showYourselfTotalerestedTitle:[Character] = ["b","t","n","_","m","e","_","e","d"]
fileprivate let appGivingData:[Character] = ["i","t"]
...
class ConstantOrangeSort: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: data_randomStackNoValue.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var rightImgV: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.installBind(name: (String(showYourselfTotalerestedTitle) + String(appGivingData))))
        //: return imag
        return imag
        //: }()
    }()
...
extension ConstantOrangeSort {
    /// 刷新
    //: func refreshCell(title: String, value: String) {
    func singleDelete(title: String, value: String) {
        //: titleLab.text = title
        titleLab.text = title
        //: valueLab.text = value
        valueLab.text = value
