...
class ValueView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        inevitably(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        inevitably(placeholder: nil, placeholderColor: nil)
    }
}
...
extension ValueView {
    ...
    private func inevitably(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(GrainDistinctionDuring().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(GrainDistinctionDuring().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-GrainDistinctionDuring().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: VideoSinkOwner().top, left: VideoSinkOwner().left, bottom: VideoSinkOwner().bottom, right: VideoSinkOwner().right)
...
extension ValueView: UITextViewDelegate {
...
extension ValueView {
    ...
    private func partnerImpression() {
