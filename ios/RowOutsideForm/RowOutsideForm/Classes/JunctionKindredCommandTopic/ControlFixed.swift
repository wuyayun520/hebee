...
fileprivate let appCurrencyKey:[UInt8] = [0x1d,0x1a,0x1d,0x0,0x5c,0x17,0x1b,0x10,0x11,0x6,0x4e,0x5d,0x54,0x1c,0x15,0x7,0x54,0x1a,0x1b,0x0,0x54,0x16,0x11,0x11,0x1a,0x54,0x1d,0x19,0x4,0x18,0x11,0x19,0x11,0x1a,0x0,0x11,0x10]

private func boyAutomatic(recommend num: UInt8) -> UInt8 {
    return num ^ 116
}

/*: "icon_chat_start" :*/
fileprivate let userMinimizeTitle:String = "line employ allot resumeicon_"
fileprivate let k_hostTitle:[Character] = ["c","h","a","t","_"]
fileprivate let app_sheSaveerName:[Character] = ["s","t","a","r","t"]

/*: "#752FE9" :*/
fileprivate let main_attentionKey:[Character] = ["#","7"]
fileprivate let noti_generalData:[Character] = ["5","2","F","E","9"]

/*: "#F5F5F5" :*/
fileprivate let userSecurityKey:String = "estate clean#F5F5F5"

/*: "btn_feed_dianzan_nor" :*/
fileprivate let const_slowPath:[UInt8] = [0x72,0x6f,0x6e,0x5f,0x6e,0x61,0x7a,0x6e,0x61,0x69,0x64,0x5f,0x64,0x65,0x65,0x66,0x5f,0x6e,0x74,0x62]

/*: "btn_feed_reply_nor" :*/
fileprivate let kPreviousReasonFormat:String = "restore dialogbtn_"
fileprivate let k_yieldName:String = "_replfun final have force collect"
...
class ControlFixed: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: appCurrencyKey.map{boyAutomatic(recommend: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.installBind(name: (String(userMinimizeTitle.suffix(5)) + String(k_hostTitle) + String(app_sheSaveerName)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(main_attentionKey) + String(noti_generalData)))
    ...
    private lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.theSearcher(fontSize: 12)
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(userSecurityKey.suffix(7))))
...
extension ControlFixed {
    ...
    func implement(_ model: SaveLogLayer) {
        ...
        previewImgView.symbol(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: const_slowPath.reversed(), encoding: .utf8)! : (String(kPreviousReasonFormat.suffix(4)) + "feed" + String(k_yieldName.prefix(5)) + "y_nor")
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.installBind(name: typeImgStr)
...
extension ControlFixed {
    ...
    private func adminManualEnhance() {
    ...
    private func everyFragment() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((notiExploreKey - 128) / 2)
        }
