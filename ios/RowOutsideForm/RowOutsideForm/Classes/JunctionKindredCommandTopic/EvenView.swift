...
fileprivate let mainNineId:[UInt8] = [0xfd,0x2,0xfd,0x8,0xbc,0xf7,0x3,0xf8,0xf9,0x6,0xce,0xbd,0xb4,0xfc,0xf5,0x7,0xb4,0x2,0x3,0x8,0xb4,0xf6,0xf9,0xf9,0x2,0xb4,0xfd,0x1,0x4,0x0,0xf9,0x1,0xf9,0x2,0x8,0xf9,0xf8]

fileprivate func completeEagerCluster(age num: UInt8) -> UInt8 {
...
/*: "#333333" :*/
fileprivate let userRebuildId:String = "#333333"

/*: "My photos" :*/
fileprivate let showBigName:[Character] = ["M","y"," ","p","h","o","t","o","s"]

/*: "#999999" :*/
fileprivate let noti_essayValue:[Character] = ["#","9","9","9","9","9","9"]

/*: "Click to change or delete photo." :*/
fileprivate let showCapDocumentFormat:[UInt8] = [0x94,0xbd,0xba,0xb4,0xbc,0x71,0xc5,0xc0,0x71,0xb4,0xb9,0xb2,0xbf,0xb8,0xb6,0x71,0xc0,0xc3,0x71,0xb5,0xb6,0xbd,0xb6,0xc5,0xb6,0x71,0xc1,0xb9,0xc0,0xc5,0xc0,0x7f]

fileprivate func quarterbackBreezeExactly(combine num: UInt8) -> UInt8 {
...
fileprivate let show_specieUrl:String = "ting length kit indexbtn_me"
fileprivate let mainBeforeName:[Character] = ["p","h","o","t","o","_","a","d","d","_","n","o","r"]

/*: "btn_me_edit_photo_add_pre" :*/
fileprivate let noti_whiteUrl:[Character] = ["b","t","n","_","m","e","_","e","d","i","t","_","p","h","o"]
fileprivate let app_originalId:String = "conversion ask column zzto_add"

/*: "btn_me_edit_photo_delete" :*/
fileprivate let user_relatePathMsg:String = "strip graphbtn_m"
fileprivate let data_helloBlindWeStr:String = "t_phoproperty wrap"
fileprivate let data_monitorMessage:[Character] = ["t","o","_","d","e","l","e","t","e"]
...
public protocol ActionLog: NSObject {
    /// 图片add
...
class EvenView: UITableViewCell {
    ...
    open weak var delegate: ActionLog?
...
//        showMessageView()
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: mainNineId.map{completeEagerCluster(age: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var titleBLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (userRebuildId.capitalized))
        //: lb.text = "My photos".localized
        lb.text = (String(showBigName)).localized
    ...
    lazy var messageLB: UILabel = {
        ...
        lb.font = UIFont.statinEssay(type: .Regular, fontSize: 12)
        //: lb.textColor = UIColor.init(hex: "#999999")
        lb.textColor = UIColor(hex: (String(noti_essayValue)))
        //: lb.text = "Click to change or delete photo.".localized
        lb.text = String(bytes: showCapDocumentFormat.map{quarterbackBreezeExactly(combine: $0)}, encoding: .utf8)!.localized
        //: return lb
        return lb
        //: }()
    }()
...
extension EvenView {
    ...
    func boundNeed() {
        ...
        for i in 0 ..< 9 {
            ...
            colorBtn.setBackgroundImage(.installBind(name: (String(show_specieUrl.suffix(6)) + "_edit_" + String(mainBeforeName))), for: .normal)
            //: colorBtn.setBackgroundImage(.BundleImageNamed(name: "btn_me_edit_photo_add_pre"), for: .highlighted)
            colorBtn.setBackgroundImage(.installBind(name: (String(noti_whiteUrl) + String(app_originalId.suffix(6)) + "_pre")), for: .highlighted)
            ...
            deleteBtn.setBackgroundImage(.installBind(name: (String(user_relatePathMsg.suffix(5)) + "e_edi" + String(data_helloBlindWeStr.prefix(5)) + String(data_monitorMessage))), for: .normal)
    ...
    @objc func cookie(sender: UIButton) {
        //: var isReturn = false
        var isReturn = false
        ...
        ReduceLevelDoingtoPrior.shadowKid(true) { (isOpen: Bool) in
            ...
            if isOpen {
                ...
                let vc = HandleDistinction.roadHonestly(maxCount: 9 - self.count, allowPhoto: true, allowVideo: false)
                ...
                vc.didFinishPickingPhotosHandle = { [weak self] (photos: [UIImage]?,
                        ...
                        if photos!.count > 0 {
                            ...
                            self.delegate?.untilSystem(photos!)
                        }
                        //: return
                }
            }
    ...
    func resolve(selete: [PropertyTitle]) {
    ...
    func compositionError(str: String) {
        //: titleBLB.text = str
        titleBLB.text = str
