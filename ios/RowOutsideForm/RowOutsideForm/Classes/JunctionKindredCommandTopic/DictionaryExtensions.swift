...
extension Dictionary {
    ...
    public static func finSimilar(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func magnitudeeractionMusic(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.finSimilar(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
