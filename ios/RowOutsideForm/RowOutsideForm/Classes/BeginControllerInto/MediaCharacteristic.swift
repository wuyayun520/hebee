...
/*: "&sr=6" :*/
fileprivate let mainSelectSeekData:[Character] = ["&","s","r","=","6"]
...
enum FlexibleMaster: String, CaseIterable {
...
class MediaCharacteristic: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func outsideTrick(urlType: EnvironmentLog) -> String {
        //: var url = VideoMagnitudeerval.share.appConfigMode.urlH5Domain
        var url = VideoMagnitudeerval.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(VideoMagnitudeerval.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : VideoMagnitudeerval.share.appUserConfigMode.fullRechargePage)
            url.append(VideoMagnitudeerval.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : VideoMagnitudeerval.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage)
            url.append(VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage.appending((String(mainSelectSeekData)))
            //: url.append(VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(VideoMagnitudeerval.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
