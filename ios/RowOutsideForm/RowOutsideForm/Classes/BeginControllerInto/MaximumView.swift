...
fileprivate let k_cornerName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
let kEntityFlexibleKey = 3.0

//: class CircleCountdownView: UIView {
class MaximumView: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.medalDensity() {
        //: willSet {
        willSet {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_cornerName.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.statinEssay(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: kEntityFlexibleKey / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: kEntityFlexibleKey / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - kEntityFlexibleKey,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - kEntityFlexibleKey)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.medalDensity().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kEntityFlexibleKey
...
extension MaximumView {
    /// 创建UI
    //: private func createUI() {
    private func betweenEffect() {
    ...
    func belowLotFin(totalTime: Int, currTime: Int) {
