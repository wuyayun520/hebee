...
struct ImpressionObserve: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var messageType = 0
...
struct AssociateExtend: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
