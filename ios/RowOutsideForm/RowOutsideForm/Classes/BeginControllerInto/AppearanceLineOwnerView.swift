...
/*: "icon_randow_user_bg" :*/
fileprivate let user_rankMessage:[Character] = ["i","c","o","n","_","r","a","n","d","o","w","_","u","s","e","r","_"]
fileprivate let appOriginAttractName:String = "BG"
...
class AppearanceLineOwnerView: UIView {
    // MARK: - UI Components

    //: private let leftAvatarView = AvatarView()
    private let leftAvatarView = ProviderTension()
    //: private let centerAvatarView = AvatarView()
    private let centerAvatarView = ProviderTension()
    //: private let rightAvatarView = AvatarView()
    private let rightAvatarView = ProviderTension()
    ...
    private func activityQuestion() {
        ...
        centerBgView.image = UIImage.installBind(name: (String(user_rankMessage) + appOriginAttractName.lowercased()))
    }

    //: private func updateAvatarDisplay() {
    private func detectDetailAngle() {
...
extension AppearanceLineOwnerView {
    // MARK: - Public Methods

    //: func configure(avatars: [String]) {
    func controlDoingDelicate(avatars: [String]) {
        ...
        detectDetailAngle()
        //: startAutoScroll()
        dimensionRawFileExtra()
    }

    //: func startAutoScroll() {
    func dimensionRawFileExtra() {
        //: stopAutoScroll()
        soundGame()
...
class ProviderTension: UIView {
    ...
    private func anyDown() {
        //: imageView.setUrlImage(urlStr: self.imageurl ?? "")
        imageView.symbol(urlStr: self.imageurl ?? "")
    }
}
