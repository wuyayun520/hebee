...
public class WithinBlock<Element> {
...
public extension WithinBlock {
    ...
    func resistanceWithRemain(where predicate: (Element)->Bool)->Element? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func ego(where predicate: (Element)->Bool)->Element? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func nativeFeedback(isIncluded: @escaping (Element)->Bool) ->WithinBlock<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        ...
        return WithinBlock(array: result)
    }

    //: func index(where predicate: (Element)->Bool)-> Int? {
    func criticism(where predicate: (Element)->Bool)-> Int? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func outContrast(by areInIncreasingOrder: (Element, Element)->Bool)->WithinBlock<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: let result = array.sorted(by: areInIncreasingOrder)
        let result = array.sorted(by: areInIncreasingOrder)
        //: let newArray = ThreadSafeArray<Element>(array: result)
        let newArray = WithinBlock<Element>(array: result)
        //: pthread_rwlock_unlock(&lock)
        pthread_rwlock_unlock(&lock)
        //: return newArray
        return newArray
    ...
    func nowhereCollection<T>(_ transform: @escaping (Element)->T) ->[T] {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func setOfFuture<T>(_ transform: (Element)->T)->[T] {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func tractor<T>(initialResult: T, _ nexPartialResult: @escaping (T, Element)->T)->T {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func distinguish(_ body: (Element)->Void) {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: array.forEach(body)
        array.forEach(body)
    ...
    func outsideBackground(where predicate: (Element)->Bool)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func fastTo(_ predicate: (Element)->Bool)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
...
public extension WithinBlock {
    ...
    func decideByPurchase(_ element: Element) {
    ...
    func decideByPurchase(_ elements: [Element]) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
        //: array += elements
        array += elements
    ...
    func restrictionBoth(_ element: Element, at index: Int) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func fasterOrExercise(at index: Int, completion: ((Element)->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func tapOf(where predicate: @escaping (Element)->Bool, completion: (([Element])->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func dreamInStrength(completion: (([Element])->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
        //: let elements = array
        let elements = array
...
public extension WithinBlock where Element: Equatable {
    //: func contains(_ element: Element)->Bool {
    func world(_ element: Element)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
...
public extension WithinBlock {
    ...
    static func +=(left: inout WithinBlock, right: Element) {
        //: left.append(right)
        left.decideByPurchase(right)
    }
