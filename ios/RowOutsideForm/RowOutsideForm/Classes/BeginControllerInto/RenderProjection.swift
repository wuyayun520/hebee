...
let mainAverageMsg = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let show_aroundTitle = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let mainFailureStr = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct RenderProjection: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
