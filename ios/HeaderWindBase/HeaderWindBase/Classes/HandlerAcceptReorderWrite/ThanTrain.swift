...
@objcMembers open class ThanTrain: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = ThanTrain()
    //: private(set) var currLanguage: String = StopBrush.getSystemLangCode()
    private(set) var currLanguage: String = StopBrush.adTotalegrity()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func include(_ language: String) {
...
extension String {
    ...
    public func fieldOf(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = PhoneAccelerate.default.languagePath
