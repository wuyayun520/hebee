...
/*: "detection" :*/
fileprivate let show_defineUrl:String = "detectithen"
fileprivate let user_installName:String = "could"

/*: "aiff" :*/
fileprivate let mainPartString:String = "aiorangeorange"
...
class DisplayVolume: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = DisplayVolume()
    ...
    func painter() {
        ...
        let soundFilePath = PhoneAccelerate.default.current(name: (show_defineUrl.replacingOccurrences(of: "then", with: "o") + user_installName.replacingOccurrences(of: "could", with: "n")), type: (mainPartString.replacingOccurrences(of: "orange", with: "f")))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            DisplayVolume.shared.processing()
        }
