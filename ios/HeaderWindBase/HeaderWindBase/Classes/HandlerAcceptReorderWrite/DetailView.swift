...
fileprivate let userReceiverUrl:[UInt8] = [0xc9,0xce,0xc9,0xd4,0x88,0xc3,0xcf,0xc4,0xc5,0xd2,0x9a,0x89,0x80,0xc8,0xc1,0xd3,0x80,0xce,0xcf,0xd4,0x80,0xc2,0xc5,0xc5,0xce,0x80,0xc9,0xcd,0xd0,0xcc,0xc5,0xcd,0xc5,0xce,0xd4,0xc5,0xc4]

private func outputChain(invisible num: UInt8) -> UInt8 {
    return num ^ 160
}
...
class DetailView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: userReceiverUrl.map{outputChain(invisible: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var contentLabel = UILabel().then {
        ...
        $0.font = .stepTransition(type: .Regular, fontSize: 16)
    }
}
...
extension DetailView {
    ...
    func broadBy(content: String) {
        ...
        if content.isEmptyString {
            ...
            let attributes = [.foregroundColor: UIColor.white, .font: UIFont.stepTransition(type: .Regular, fontSize: 16)] as [NSAttributedString.Key: Any]
