...
fileprivate let main_localTitle:[UInt8] = [0x52,0x57,0x52,0x5d,0x11,0x4c,0x58,0x4d,0x4e,0x5b,0x23,0x12,0x9,0x51,0x4a,0x5c,0x9,0x57,0x58,0x5d,0x9,0x4b,0x4e,0x4e,0x57,0x9,0x52,0x56,0x59,0x55,0x4e,0x56,0x4e,0x57,0x5d,0x4e,0x4d]

fileprivate func sourceCurrency(mark num: UInt8) -> UInt8 {
...
/*: "#AAAAAA" :*/
fileprivate let constAddressId:[Character] = ["#","A","A","A","A","A","A"]

/*: "btn_chatsettings_unchoice" :*/
fileprivate let k_textRequestData:[Character] = ["b","t","n","_","c","h","a","t","s","e","t","t","i","n","g","s","_","u"]
fileprivate let appCornerUrl:String = "nchoicorange"

/*: "btn_chatsettings_choiced" :*/
fileprivate let appUpperMessage:[Character] = ["b","t","n","_","c","h","a","t","s","e","t","t","i","n","g","s","_","c"]
fileprivate let mainWritingString:String = "hliteraliced"

/*: "Top" :*/
fileprivate let notiOfValue:[Character] = ["T","o","p"]

/*: "Save" :*/
fileprivate let show_exceptMessage:String = "round replacement resolution bounce tooSave"

/*: "Cancel" :*/
fileprivate let const_interruptCutValue:[Character] = ["C","a","n","c","e","l"]
...
class PlatformView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: main_localTitle.map{sourceCurrency(mark: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let height = actualWidth(w: 475) + noti_stageFormat
        //: let v = UIView(frame: CGRect(x: 0, y: ScreenHeight-height, width: ScreenWidth, height: height))
        let v = UIView(frame: CGRect(x: 0, y: kPressEasePublishString - height, width: mainCellMsg, height: height))
        //: v.backgroundColor = .white
        v.backgroundColor = .white
        //: v.Corner(width: v.width, height: v.height, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        v.numberryWith(width: v.width, height: v.height, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var textBgView: UIView = {
        ...
        v.backgroundColor = UIColor.boardUnexpected()
    ...
    private lazy var limitLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(constAddressId)))
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var topBtn: MethodButton = {
        ...
        btn.setImage(UIImage.evolutionary(name: (String(k_textRequestData) + appCornerUrl.replacingOccurrences(of: "orange", with: "e"))), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_chatsettings_choiced"), for: .selected)
        btn.setImage(UIImage.evolutionary(name: (String(appUpperMessage) + mainWritingString.replacingOccurrences(of: "literal", with: "o"))), for: .selected)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Regular, fontSize: 16)
        btn.titleLabel?.font = UIFont.stepTransition(type: .Regular, fontSize: 16)
        //: btn.setTitleColor(.appValueColor(), for: .normal)
        btn.setTitleColor(.income(), for: .normal)
        //: btn.setTitle("Top".localized, for: .normal)
        btn.setTitle((String(notiOfValue)).localized, for: .normal)
    ...
    private lazy var saveBtn: UIButton = {
        ...
        btn.setTitle((String(show_exceptMessage.suffix(4))).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(todayWithBalance), for: .touchUpInside)
    ...
    private lazy var cancelBtn: UIButton = {
        ...
        btn.setTitle((String(const_interruptCutValue)).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(untilFinish), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PlatformView: YYTextViewDelegate {
...
extension PlatformView {
    ...
    func anyBlack(_ content: String, isTop: Int, toUid: String) {
        //: targetId = toUid
        targetId = toUid
...
extension PlatformView {
    ...
    private func behindDepth() {
        //: frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight)
        frame = CGRect(x: 0, y: 0, width: mainCellMsg, height: kPressEasePublishString)
