...
fileprivate let main_boundString:[UInt8] = [0x56,0x51,0x56,0x4b,0x17,0x5c,0x50,0x5b,0x5a,0x4d,0x5,0x16,0x1f,0x57,0x5e,0x4c,0x1f,0x51,0x50,0x4b,0x1f,0x5d,0x5a,0x5a,0x51,0x1f,0x56,0x52,0x4f,0x53,0x5a,0x52,0x5a,0x51,0x4b,0x5a,0x5b]

/*: "btn_me_edit" :*/
fileprivate let app_cutSufficientFormat:[Character] = ["b"]
fileprivate let const_holderWithFormat:String = "tn_mpull disable rocket price"
...
class IsolateMeasure: UITableViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: main_boundString.map{$0^63}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.evolutionary(name: (String(app_cutSufficientFormat) + String(const_holderWithFormat.prefix(4)) + "e_edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.alongOccur()
...
extension IsolateMeasure {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func drop(titile: String, row: Int, isLast: Bool) {
    ...
    func label() {
        ...
        titleBLB.font = UIFont.stepTransition(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.stepTransition(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
