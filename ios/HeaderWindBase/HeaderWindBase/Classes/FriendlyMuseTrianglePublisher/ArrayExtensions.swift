...
public class ControlDistribution<Element> {
...
public extension ControlDistribution {
    //: var first: Element? {
    var first: Element? {
        //: var result: Element?
        var result: Element?
...
public extension ControlDistribution {
    ...
    func nearSpecify(where predicate: (Element)->Bool)->Element? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func consumerEquipment(where predicate: (Element)->Bool)->Element? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func doingIn(isIncluded: @escaping (Element)->Bool) ->ControlDistribution<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        ...
        return ControlDistribution(array: result)
    }

    //: func index(where predicate: (Element)->Bool)-> Int? {
    func whiteThat(where predicate: (Element)->Bool)-> Int? {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func awayEntity(by areInIncreasingOrder: (Element, Element)->Bool)->ControlDistribution<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: let result = array.sorted(by: areInIncreasingOrder)
        let result = array.sorted(by: areInIncreasingOrder)
        //: let newArray = ThreadSafeArray<Element>(array: result)
        let newArray = ControlDistribution<Element>(array: result)
        //: pthread_rwlock_unlock(&lock)
        pthread_rwlock_unlock(&lock)
        //: return newArray
        return newArray
    ...
    func availability<T>(_ transform: @escaping (Element)->T) ->[T] {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func marginDisappear<T>(_ transform: (Element)->T)->[T] {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func consumptionDirection<T>(initialResult: T, _ nexPartialResult: @escaping (T, Element)->T)->T {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func deliveryParty(_ body: (Element)->Void) {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: array.forEach(body)
        array.forEach(body)
    ...
    func playArea(where predicate: (Element)->Bool)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
    ...
    func listen(_ predicate: (Element)->Bool)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
...
public extension ControlDistribution {
    ...
    func behindRefuse(_ element: Element) {
    ...
    func behindRefuse(_ elements: [Element]) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
        //: array += elements
        array += elements
    ...
    func appearanceOff(_ element: Element, at index: Int) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func plateAcrossAround(at index: Int, completion: ((Element)->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func sessionBlue(where predicate: @escaping (Element)->Bool, completion: (([Element])->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
    ...
    func answerInner(completion: (([Element])->Void)? = nil) {
        //: pthread_rwlock_wrlock(&lock)
        pthread_rwlock_wrlock(&lock)
        //: let elements = array
        let elements = array
...
public extension ControlDistribution where Element: Equatable {
    //: func contains(_ element: Element)->Bool {
    func todayLoad(_ element: Element)->Bool {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
...
public extension ControlDistribution {
    ...
    static func +=(left: inout ControlDistribution, right: Element) {
        //: left.append(right)
        left.behindRefuse(right)
    }
