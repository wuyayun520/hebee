...
fileprivate let const_appearFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "JXBannerCellID" :*/
fileprivate let notiReachTitle:[Character] = ["J","X","B","a","n","n","e","r","C","e","l"]
fileprivate let mainChainKey:String = "lIDmusic framework orange substantial"
...
class HeroExclusive: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: const_appearFormat.reversed(), encoding: .utf8)!)
    }
...
extension HeroExclusive: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(notiReachTitle) + String(mainChainKey.prefix(3))))
    }
...
extension HeroExclusive {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func dropTo(bannerData: [ProcessingEase]) {
