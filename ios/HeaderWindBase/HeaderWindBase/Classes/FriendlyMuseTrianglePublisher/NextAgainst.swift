...
@objc public enum NextIndex: UInt {
...
@objc public enum PhaseStep: UInt {
 ...
 */
//: @objcMembers public class NextAgainst: TCommonCellData {
@objcMembers public class NextAgainst: EventColor {
    ...
    public var direction: PhaseStep = .MsgDirectionIncoming
    ...
    public var translateStatus: NextIndex = .MsgTranslate_init
    ...
    public var msgModel: PadModel = PadModel()
    ...
    public var cellLayout: PainterHero!
    ...
    public init(direction: PhaseStep) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.smartThreshold()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = PainterHero(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = PainterHero(isIncomming: false)
    ...
    public func reduceQuick() -> CGSize {
        //: return CGSize.zero
        return CGSize.zero
    }
    ...
    public override func enableSmart(_ width: CGFloat) -> CGFloat {
