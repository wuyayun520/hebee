...
/*: "bg_chat_honey_left" :*/
fileprivate let main_sharedKey:[Character] = ["b","g","_","c","h","a","t","_","h","o","n"]
fileprivate let show_mustMessage:String = "provider beginey_left"

/*: "bg_chat_honey_right" :*/
fileprivate let noti_crushProfessionalKey:String = "bg_chres op don within"
fileprivate let mainTransactionTitle:String = "ney_holder already subtle member element"

/*: "init(coder:) has not been implemented" :*/
fileprivate let userProcessAdvancedName:[UInt8] = [0xe,0x9,0xe,0x13,0x4f,0x4,0x8,0x3,0x2,0x15,0x5d,0x4e,0x47,0xf,0x6,0x14,0x47,0x9,0x8,0x13,0x47,0x5,0x2,0x2,0x9,0x47,0xe,0xa,0x17,0xb,0x2,0xa,0x2,0x9,0x13,0x2,0x3]

/*: "#FA74B7" :*/
fileprivate let noti_homeUrl:[Character] = ["#","F","A","7","4","B","7"]

/*: "icon_coin" :*/
fileprivate let main_tickPath:String = "appropriate middle op indicatoricon_"
...
//: @objcMembers public class EagerShould: TalkingChatMsgBaseCellData {
@objcMembers public class EagerShould: AgileGate {
    ...
    override public init(direction: PhaseStep) {
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.bubbleImg = UIImage.enhanceAboutWithinRoundingEvaluationRecent(name: (String(main_sharedKey) + String(show_mustMessage.suffix(7))))
            ...
            self.bubbleImg = UIImage.enhanceAboutWithinRoundingEvaluationRecent(name: (String(noti_crushProfessionalKey.prefix(5)) + "at_ho" + String(mainTransactionTitle.prefix(4)) + "right"))
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: userProcessAdvancedName.map{$0^103}, encoding: .utf8)!)
    }
    ...
    public lazy var attributedString: NSMutableAttributedString = {
        ...
        let attr = toSensor(giftModel: self.msgModel)
        //: return attr
        return attr
        //: }()
    }()
    ...
    func toSensor(giftModel: PadModel) -> NSMutableAttributedString {
        ...
        let giftname = persist(giftmodel: giftModel.msgInfo.wantGift)
        ...
        let attr1 = NSMutableAttributedString(string: str, attributes: [.font: font, .foregroundColor: UIColor.labelMomentum()])
        //: let attr2 = NSMutableAttributedString.init(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor.init(hex: "#FA74B7")!])
        let attr2 = NSMutableAttributedString(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(noti_homeUrl)))!])
        ...
        let attr3 = NSMutableAttributedString(string: "\(giftModel.msgInfo.wantGift.giftPrice)", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(noti_homeUrl)))!])
        ...
        giftImgV.basicReflect(urlStr: giftModel.msgInfo.wantGift.giftIcon)
        ...
        giftImgV2.image = UIImage.evolutionary(name: (String(main_tickPath.suffix(5)) + "coin"))
    ...
    func persist(giftmodel: ObserverModel) -> String {
        ...
        if PutDirection.share.interfaceLang == TempStroke.en.rawValue {
            ...
            gameName = giftmodel.giftNameI18n[TempStroke.en.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[TempStroke.ar.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[TempStroke.es.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[TempStroke.pt.rawValue] as? NSString ?? ""
        }
