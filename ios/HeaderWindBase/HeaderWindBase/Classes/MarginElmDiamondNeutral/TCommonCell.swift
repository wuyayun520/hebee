...
@objcMembers public class EventColor: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func enableSmart(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class BoxDescription: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: EventColor?
    ...
    @objc dynamic public func creationCharacter(with data: EventColor) {
        //: self.data = data
        self.data = data
    }
} 
