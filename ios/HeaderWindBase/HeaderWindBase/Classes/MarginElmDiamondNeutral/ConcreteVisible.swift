...
open class ConcreteVisible: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = ConcreteVisible.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
