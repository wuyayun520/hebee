...
fileprivate let showPriorityFormat:[UInt8] = [0x95,0x92,0x95,0x88,0xd4,0x9f,0x93,0x98,0x99,0x8e,0xc6,0xd5,0xdc,0x94,0x9d,0x8f,0xdc,0x92,0x93,0x88,0xdc,0x9e,0x99,0x99,0x92,0xdc,0x95,0x91,0x8c,0x90,0x99,0x91,0x99,0x92,0x88,0x99,0x98]
...
class RateAbout: PlateTarget {
    //: override var msgModel: TalkingLiveRoomDanmuModel {
    override var msgModel: ShapeCalculate {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: showPriorityFormat.map{$0^252}, encoding: .utf8)!)
    }
}
