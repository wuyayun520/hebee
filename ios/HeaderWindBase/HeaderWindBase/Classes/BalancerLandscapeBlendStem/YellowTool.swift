...
fileprivate let k_entryCollectString:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_userdetail_header_shadow" :*/
fileprivate let data_partnerWeeklyPath:String = "icoanonymous"
fileprivate let data_spendName:String = "etfunil"
fileprivate let showHideSourceString:String = "zone decide productionr_shadow"

/*: "icon_lounge" :*/
fileprivate let main_specifyPetData:[Character] = ["i","c","o","n","_"]
fileprivate let constRunValue:String = "lagentnge"

/*: "Official" :*/
fileprivate let data_followValue:String = "Officialblue begin post stack"

/*: "Reviewing" :*/
fileprivate let noti_holderTermsData:[Character] = ["R","e","v","i","e","w","i","n","g"]

/*: "#FF506D" :*/
fileprivate let mainFlexBorderPath:String = "#FF506anima another from"
fileprivate let const_positionKey:String = "bound"

/*: "icon_user_detail_intimate_header" :*/
fileprivate let mainRapidTitle:[UInt8] = [0xab,0xa1,0xad,0xac,0x9d,0xb7,0xb1,0xa7,0xb0,0x9d,0xa6,0xa7,0xb6,0xa3,0xab,0xae,0x9d,0xab,0xac,0xb6,0xab,0xaf,0xa3,0xb6,0xa7,0x9d,0xaa,0xa7,0xa3,0xa6,0xa7,0xb0]

private func actualQuit(dialog num: UInt8) -> UInt8 {
    return num ^ 194
}

/*: "?toUid= :*/
fileprivate let show_markerName:String = "?toUid=region disabled feedback shall turn"

/*: "ViewIcon" :*/
fileprivate let kReserveClusterStatValue:String = "lat yetTUserDe"
fileprivate let kBlindKey:String = "taisubstantial"
fileprivate let show_activeTitle:String = "Itemmargin currently"

/*: "#FFFFFF" :*/
fileprivate let notiEasyIdentifyData:String = "bit pass#FFFFFF"

/*: "#BDB8B5" :*/
fileprivate let k_comprehensiveUrl:[Character] = ["#","B","D","B","8"]
fileprivate let mainAbsoluteString:String = "Bcolor"

/*: "head_detail_bottom" :*/
fileprivate let k_pleaseAfterPath:[Character] = ["h","e","a","d","_","d"]
fileprivate let const_jumpMarkerThreeUrl:String = "etail_extend menu suspend error calculation"
fileprivate let showCollectionLeaveString:String = "bquantityttquantitym"

/*: "#2DF2FF" :*/
fileprivate let dataResolveFormat:[Character] = ["#","2","D","F","2","F","F"]

/*: "Live" :*/
fileprivate let constPlaceValue:String = "Livesound section around"

/*: "#48FF1E" :*/
fileprivate let kNothingData:String = "#48FF1Eenable account delivery"

/*: "Online" :*/
fileprivate let dataDealLabelStr:String = "contain again normal reductionOnline"

/*: "#FF4B7F" :*/
fileprivate let app_adviceAutomaticallyFormat:String = "activity everyone sine warning say#FF4B7F"

/*: "busy" :*/
fileprivate let mainGoingMovieMsg:[Character] = ["b","u","s","y"]
...
let k_arrayTitle = (302.0 + data_visitorPath)

//: class TalkingUserDetailHeaderView: UIView {
class YellowTool: UIView {
    //: var VideoCallBlock: (() -> Void)?
    var VideoCallBlock: (() -> Void)?
    //: private var userInfoModel = TalkingUserInfoModel()
    private var userInfoModel = EstimatedCharacteristic()
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_entryCollectString.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var bannerView: JXBanner = {
        ...
        view.placeholderImgView.image = UIImage.cleanRun()
    ...
    private lazy var shadowBgView: UIImageView = {
        ...
        let v = UIImageView(image: UIImage.evolutionary(name: (data_partnerWeeklyPath.replacingOccurrences(of: "anonymous", with: "n") + "_userd" + data_spendName.replacingOccurrences(of: "fun", with: "a") + "_heade" + String(showHideSourceString.suffix(8)))))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var vipBgView: UIImageView = {
        ...
        v.frame = CGRect(x: 0, y: k_arrayTitle - 15, width: mainCellMsg, height: 15)
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var nicknameLab: UILabel = {
        ...
        lab.font = UIFont.stepTransition(type: .Medium, fontSize: 19)
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.evolutionary(name: (String(main_specifyPetData) + constRunValue.replacingOccurrences(of: "agent", with: "ou")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var officalImgV: UIButton = {
        ...
        img.setTitle((String(data_followValue.prefix(8))).localized, for: .normal)
    ...
    private lazy var onlineImgV: MethodButton = {
    ...
    private lazy var liveView: NaturalPainterFragment = {
        //: let v = UserLivePullStreamsView()
        let v = NaturalPainterFragment()
        //: v.isHidden = true
        v.isHidden = true
        //: v.playEndBlock = {
        v.playEndBlock = {
        ...
        v.tapGestureBlock = { [weak self] in
            ...
            guard let self = self else { return }
            //: RetainProcess.share.func_audiencePushToLiveRoomVC(uid: self.userInfoModel.uid, enterType: .userDetail)
            RetainProcess.share.isSuspend(uid: self.userInfoModel.uid, enterType: .userDetail)
        }
        //: return v
        return v
        //: }()
    ...
    private lazy var reViewingLB: UILabel = {
        ...
        lb.text = (String(noti_holderTermsData)).localized
        //: lb.textColor = .white
        lb.textColor = .white
        //: lb.backgroundColor = UIColor.init(hex: "#FF506D")
        lb.backgroundColor = UIColor(hex: (String(mainFlexBorderPath.prefix(6)) + const_positionKey.replacingOccurrences(of: "bound", with: "D")))
    ...
    lazy var lastLoginLab: UILabel = {
        ...
        lb.font = .stepTransition(type: .Medium, fontSize: 12)
        //: lb.textColor = .white
        lb.textColor = .white
        //: return lb
        return lb
    ...
    private lazy var intimateBtn: MethodButton = {
        //: let btn = TalkingButton()
        let btn = MethodButton()
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_user_detail_intimate_header"), for: .normal)
        btn.setImage(UIImage.evolutionary(name: String(bytes: mainRapidTitle.map{actualQuit(dialog: $0)}, encoding: .utf8)!), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
        //: btn.addTarget(self, action: #selector(intimateBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(agile), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension YellowTool {
    /// 查看视频
    //: private func goToVideo() {
    private func week() {
        //: let vc = TalkingMomentVideoVC.init(videoPath: self.userInfoModel.videoUrl)
        let vc = GraphEmbraceViewController(videoPath: self.userInfoModel.videoUrl)
        //: if MountCustom.share.loginUid != self.userInfoModel.uid {
        if MountCustom.share.loginUid != self.userInfoModel.uid {
    ...
    private func resume(_ index: Int) {
        ...
        var tempArr: [CurrentScenario] = []
        //: var model = TalkingMomentPhotoModel.init()
        var model = CurrentScenario()
        ...
        var currenModel = FrequencyModel()
        ...
        let vc = TellView(momentModel: currenModel, index: index, type: .normal)
        //: self.currentViewController()?.navigationController?.pushViewController(vc, animated: true)
        self.alongLarge()?.navigationController?.pushViewController(vc, animated: true)
    }
    ...
    @objc func agile() {
        ...
        let url = AverageGraph.strengthButtonEdit(urlType: .Intimate) + (String(show_markerName.prefix(7))) + "\(self.userInfoModel.uid)"
...
extension YellowTool: JXBannerDataSource {
    ...
    func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
        ...
        return JXBannerCellRegister(type: ViewIcon.self, reuseIdentifier: (String(kReserveClusterStatValue.suffix(7)) + kBlindKey.replacingOccurrences(of: "substantial", with: "l") + "Header" + String(show_activeTitle.prefix(4)) + "Cell"))
    }

    //: func jxBanner(_ banner: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
    func jxBanner(_ banner: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        //: let bannerCell = cell as! TUserDetailHeaderItemCell
        let bannerCell = cell as! ViewIcon
        //: let urlStr = self.dataArray[index]
        let urlStr = self.dataArray[index]

        //: if index == 0 && userInfoModel.sex == Gender.female.rawValue && userInfoModel.videoUrl.count>1 {
        if index == 0 && userInfoModel.sex == BasicIndependent.female.rawValue && userInfoModel.videoUrl.count > 1 { // 视频
            //: bannerCell.setVideoView()
            bannerCell.social()
            //: bannerCell.configModel(videoUrl: userInfoModel.videoUrl, imgUrl: userInfoModel.cover)
            bannerCell.shMedal(videoUrl: userInfoModel.videoUrl, imgUrl: userInfoModel.cover)
            ...
            bannerCell.bgImgView.containRetain(urlStr: urlStr, placeImg: UIImage.untilAlways())
        }
    ...
    func jxBanner(_ banner: JXBannerType, centerIndex: Int, centerCell: UICollectionViewCell) {
        //: guard userInfoModel.uid == MountCustom.share.loginUid else {
        guard userInfoModel.uid == MountCustom.share.loginUid else {
            //: return
            return
        }
    ...
    func jxBanner(pageControl banner: JXBannerType, numberOfPages: Int, coverView: UIView, builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder {
        ...
        pageControl.activeColor = UIColor(hex: (String(notiEasyIdentifyData.suffix(7))))!
        //: pageControl.inactiveColor = UIColor(hex: "#BDB8B5")!
        pageControl.inactiveColor = UIColor(hex: (String(k_comprehensiveUrl) + mainAbsoluteString.replacingOccurrences(of: "color", with: "5")))!
...
extension YellowTool: JXBannerDelegate {
    //: public func jxBanner(_ banner: JXBannerType, didSelectItemAt index: Int) {
    public func jxBanner(_ banner: JXBannerType, didSelectItemAt index: Int) {
        //: if index == 0 && userInfoModel.sex == Gender.female.rawValue && userInfoModel.videoUrl.count>1 {
        if index == 0 && userInfoModel.sex == BasicIndependent.female.rawValue && userInfoModel.videoUrl.count > 1 {
            //: goToVideo()
            week()
            ...
            if userInfoModel.sex == BasicIndependent.female.rawValue && userInfoModel.videoUrl.count > 1 && curren > 0 {
                //: curren -= 1
                curren -= 1
            }
            //: goToPhoto(curren)
...
extension YellowTool {
    ...
    func oval(_ userModel: EstimatedCharacteristic) {
        ...
        if userModel.sex == BasicIndependent.female.rawValue && userModel.videoUrl.count > 1 {
        ...
        let normalImg = UIImage.evolutionary(name: (String(k_pleaseAfterPath) + String(const_jumpMarkerThreeUrl.prefix(6)) + showCollectionLeaveString.replacingOccurrences(of: "quantity", with: "o"))).withTintColor(.white)
        //: if userModel.loungePlus {
        if userModel.loungePlus {
            //: if let vipModel = MountCustom.share.appUserConfigMode.vipSetting.filter({$0.vipSkinId == userModel.vipSkinId}).first {
            if let vipModel = MountCustom.share.appUserConfigMode.vipSetting.filter({ $0.vipSkinId == userModel.vipSkinId }).first {
                //: vipBgView.setUrlImage(urlStr: vipModel.vipSkinTop, placeImg: normalImg)
                vipBgView.containRetain(urlStr: vipModel.vipSkinTop, placeImg: normalImg)
            }
            //: } else {
        } else {
        ...
        self.nicknameLab.textColor = userModel.loungePlus ? .fireReplace() : .white
        ...
        if userModel.intimateUrl.count > 0 {
            ...
            intimateImgV.accessiblePending(urlStr: userModel.intimateUrl)
        }
        // 在线状态
        ...
        if userModel.livePlayUrl.count > 0 {
            ...
            let image = UIImage.independentIgnore(color: UIColor(hex: (String(dataResolveFormat)))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.measureVisitor(), for: .normal)
            onlineImgV.setImage(image.measureVisitor(), for: .normal)
            //: onlineImgV.setTitle("Live".localized, for: .normal)
            onlineImgV.setTitle((String(constPlaceValue.prefix(4))).localized, for: .normal)
            ...
            let image = UIImage.independentIgnore(color: UIColor(hex: (String(kNothingData.prefix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.measureVisitor(), for: .normal)
            onlineImgV.setImage(image.measureVisitor(), for: .normal)
            //: onlineImgV.setTitle("Online".localized, for: .normal)
            onlineImgV.setTitle((String(dataDealLabelStr.suffix(6))).localized, for: .normal)
            ...
            let image = UIImage.independentIgnore(color: UIColor(hex: (String(app_adviceAutomaticallyFormat.suffix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.measureVisitor(), for: .normal)
            onlineImgV.setImage(image.measureVisitor(), for: .normal)
            //: onlineImgV.setTitle("busy".localized, for: .normal)
            onlineImgV.setTitle((String(mainGoingMovieMsg)).localized, for: .normal)
            //: } else {
        } else {
        ...
        // 直播
        //: if MountCustom.share.loginUid != userModel.uid &&
        if MountCustom.share.loginUid != userModel.uid,
        ...
        if liveView.isHidden == false {
            ...
            liveView.checkedCommit(liveUrl: userModel.livePlayUrl)
        }
    }
    ...
    private func tweenOf() {
        //: liveView.snp.makeConstraints { make in
        liveView.snp.makeConstraints { make in
            //: make.trailing.equalToSuperview()
            make.trailing.equalToSuperview()
            //: make.top.equalTo(StatusBarHeight+80)
            make.top.equalTo(data_visitorPath + 80)
        ...
        reViewingLB.snp.makeConstraints { make in
            ...
            make.top.equalToSuperview().offset(data_visitorPath + 15)
