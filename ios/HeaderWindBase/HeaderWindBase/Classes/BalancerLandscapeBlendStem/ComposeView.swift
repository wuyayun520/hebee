...
fileprivate let main_disableName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "img_match_shadow" :*/
fileprivate let showEndWholeMemberPath:String = "img_constant continuing week rem"
fileprivate let show_rawMsg:String = "publishdow"

/*: "icon_match_topshowdown" :*/
fileprivate let dataThatString:[Character] = ["i","c","o","n","_","m","a","t","c","h","_","t","o","p","s"]
fileprivate let constTransactionFrameworkUrl:String = "hanswerdanswern"

/*: "Matching..." :*/
fileprivate let showHarassmentUrl:String = "today brush move sibling generalMatchi"

/*: "get json error" :*/
fileprivate let noti_identityUrl:String = "get jaddition session receiver sort"
fileprivate let noti_gravityIncreasePath:String = "minimumor"

/*: "img_home_shadow" :*/
fileprivate let main_betterBassKey:[Character] = ["i","m","g","_","h","o","m","e","_","s"]
fileprivate let showPurpleStr:[Character] = ["h","a","d","o","w"]

/*: "icon_home_girl" :*/
fileprivate let kPicJobPath:String = "ifraction"
fileprivate let appLocationOpPath:String = "on_homopen bridge"
...
typealias TouchCallBlock = (_ model: TrackLite) -> Void

//: class TalkingClubCardItemCell: TalkingClubCardViewCell {
class ComposeView: CancelSmart {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: main_disableName.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var gradientShadowImageView: UIImageView = {
        ...
        imageView.image = UIImage.evolutionary(name: (String(showEndWholeMemberPath.prefix(4)) + "match_s" + show_rawMsg.replacingOccurrences(of: "publish", with: "ha")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var topShowdImageView: UIImageView = {
        ...
        imageView.image = UIImage.evolutionary(name: (String(dataThatString) + constTransactionFrameworkUrl.replacingOccurrences(of: "answer", with: "ow")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var sexBtn: UIButton = {
        ...
        btn.titleLabel?.font = .stepTransition(type: .Medium, fontSize: 13)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var matchTipsLabel: UILabel = {
        ...
        label.text = (String(showHarassmentUrl.suffix(6)) + "ng...").localized
        //: label.isHidden = true
        label.isHidden = true
        //: return label
        return label
    ...
    private lazy var callBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(sinceSuspend), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var callPlayer: SVGAPlayer = {
        ...
        let url = PhoneAccelerate.default.memberStructure(type: .Match_userCall)
        //: do {
        do {
            ...
            printLog(message: (String(noti_identityUrl.prefix(5)) + "son e" + noti_gravityIncreasePath.replacingOccurrences(of: "minimum", with: "rr")))
        }
        //: return player
        return player
        //: }()
...
extension ComposeView {
    ...
    func disappearByRoot(model: TrackLite) {
        //: self.model = model
        self.model = model
        ...
        if model.cover.count > 0 {
            ...
            userImageView.containRetain(urlStr: model.cover, placeImg: UIImage.evolutionary(name: (String(main_betterBassKey) + String(showPurpleStr))))
            ...
            userImageView.containRetain(urlStr: model.headPic, placeImg: UIImage.evolutionary(name: (String(main_betterBassKey) + String(showPurpleStr))))
            //: } else {
        } else {
            //: userImageView.image = UIImage.BundleImageNamed(name: "img_home_shadow")
            userImageView.image = UIImage.evolutionary(name: (String(main_betterBassKey) + String(showPurpleStr)))
        }
        //: userIconImg.setUrlImage(urlStr: model.headPic, placeImg: nil)
        userIconImg.accessiblePending(urlStr: model.headPic, placeImg: nil)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
        sexBtn.setBackgroundImage(UIImage.evolutionary(name: (kPicJobPath.replacingOccurrences(of: "fraction", with: "c") + String(appLocationOpPath.prefix(6)) + "e_girl")), for: .normal)
    ...
    @objc private func sinceSuspend() {
