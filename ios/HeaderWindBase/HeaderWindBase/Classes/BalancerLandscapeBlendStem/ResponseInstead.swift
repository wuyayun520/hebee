...
let mainSuccessGenerateNetName = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let show_changeSubsequentMsg = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let user_distinctionPath = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct ResponseInstead: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
