...
@class SignRegulateModel, FeedbackModel, PushModel, DistinctionModel, IndependentModel, BoundMeasureTrack, EmbraceSceneModel, ResolveGreenModel, LockModel, RadioModel, PinSmallModel, ObserverModel;

//: @interface AbTalkingChatMsgBaseModel : JSONModel
@interface PadModel : JSONModel

//: @property (nonatomic, strong)AbTalkingChatMsgInfoModel *msgInfo;
@property (nonatomic, strong)SignRegulateModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)FeedbackModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)PushModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)DistinctionModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)IndependentModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)RadioModel *quoteMsgInfo;

//: @property (nonatomic, strong)BoundMeasureTrack *userInfoModel;
@property (nonatomic, strong)BoundMeasureTrack *userInfoModel;
...
@interface SignRegulateModel : JSONModel
...
@property (nonatomic, strong) EmbraceSceneModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ResolveGreenModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) LockModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) ObserverModel *wantGift; /// 想要礼物
...
@property (nonatomic, strong) NSArray<SectionModel> *replay; /// v1.9.8 男性用户需要回复的选择内容
...
@interface EmbraceSceneModel : JSONModel
...
@interface ResolveGreenModel: JSONModel
...
@interface DistinctionModel : JSONModel
...
@interface IndependentModel : JSONModel
...
@interface ObserverModel : JSONModel
...
@property (nonatomic, strong) PinSmallModel *renderData;
...
@interface PinSmallModel : JSONModel
