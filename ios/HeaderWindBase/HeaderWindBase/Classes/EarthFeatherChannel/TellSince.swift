...
/*: "App" :*/
fileprivate let dataDiscoverAnglePath:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let noti_ionNowData:String = "blockLicon enhance other subsequent"
fileprivate let dataWedName:String = "tell general visitist_"
...
class TellSince: NSObject {
    ...
    func robotSwitche(userId: String) {
    ...
    func fragmentByAnalyze(userId: String) {
    ...
    func bounceFileRunEnableicial(userId: String) -> Bool {
    ...
    private func aboveNoteMp() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(dataDiscoverAnglePath)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(noti_ionNowData.prefix(6)) + String(dataWedName.suffix(4))) + "\(uid)")
        //: return filePath
        return filePath
    }
}
