...
extension Dictionary {
    ...
    public static func reduceControl(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func exerciseDoing(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.reduceControl(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
