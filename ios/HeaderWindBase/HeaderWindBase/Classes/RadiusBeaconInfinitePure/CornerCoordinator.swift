...
fileprivate let appAlreadyPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class CornerCoordinator: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.feed()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.notSecure()
    ...
    var menuModel: FactoryMechanismCountervalModel? {
        //: didSet {
        didSet {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: appAlreadyPath.reversed(), encoding: .utf8)!)
    }
    ...
    private func notSecure() -> UILabel {
    ...
    private func official() {
        ...
        lineLayer.strokeColor = UIColor.roundItem(230, 230, 230, 1.0).cgColor
