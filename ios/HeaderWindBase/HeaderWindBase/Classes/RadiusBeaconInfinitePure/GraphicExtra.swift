...
@objcMembers class GraphicExtra: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: FlexWithoutEvolution?
    //: var gift: TalkingMsgGiftModel?
    var gift: NextLevel?
    //: var user: TalkingMsgUserModel?
    var user: CanPlayModel?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: ChapterTitle?
...
class FlexWithoutEvolution: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class CanPlayModel: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class ChapterTitle: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class NextLevel: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
