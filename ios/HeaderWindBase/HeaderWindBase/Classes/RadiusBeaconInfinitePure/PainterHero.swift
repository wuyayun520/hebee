...
@objcMembers public class PainterHero: NSObject {
    ...
    class func panel() -> PainterHero {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = PainterHero.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func totaloAcross() -> PainterHero {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PainterHero.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func particleComponent() -> PainterHero {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PainterHero.init(isIncomming: false)
    ...
    class func thumbIn() -> PainterHero {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = PainterHero.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func occasion() -> PainterHero {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PainterHero.init(isIncomming: false)
        //: return layout
        return layout
