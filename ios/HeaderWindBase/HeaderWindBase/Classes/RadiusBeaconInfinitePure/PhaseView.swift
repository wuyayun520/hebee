...
fileprivate let constPaintMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class PhaseView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: constPaintMessage.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.stepTransition(type: .Semibold, fontSize: 19)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.income().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = const_mineValue
...
extension PhaseView {
    ...
    func timeHoldCookieMoreEditorExample(totalTime: Int, currTime: Int) {
