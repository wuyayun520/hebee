...
Pod::Spec.new do |s|
  s.name         = "HeaderWindBase"
  s.version      = "1.0.0"
  s.summary      = "iOS HeaderWindBase Module."
  s.author       = { "HeaderWindBase" => "HeaderWindBase.me" }
  s.homepage     = "HeaderWindBase"
  s.source       = { :git => "http://HeaderWindBase.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'HeaderWindBase/Classes/**/*'
  s.resources = "HeaderWindBase/Resources/*.bundle"
#  s.vendored_libraries = 'HeaderWindBase/Classes/**/*.a'
